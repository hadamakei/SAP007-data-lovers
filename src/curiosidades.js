...
function exibeMediaDePersonagens(data){
  ...
  let valorMaior = calculoAgregado(personagens, "maior", "age");
  let valorMenor = calculoAgregado(personagens, "menor", "age");
  let mediaPersonagens = calculoAgregado(personagens, "media", "age");
  resultado.innerHTML= `
  <div class="info">
